...
public class Test1 {
    ...
    public void CamelCase1(){
        ...
        Assert.assertTrue("result should be  I Live In Usa but your result is " + result,result.trim().equals("I Live In Usa"));
    ...
    public void CamelCase2(){
        ...
        Assert.assertTrue("result should be --> Say That An Element In <--but your result is " + result,result.trim().equals("Say That An Element In"));
